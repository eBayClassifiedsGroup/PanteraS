...
[![Current Release](http://img.shields.io/badge/release-0.3.1-blue.svg)](https://github.com/eBayClassifiedsGroup/PanteraS/releases/tag/v0.3.1)
...
Clone it
```
git clone -b 0.3.1 https://github.com/eBayClassifiedsGroup/PanteraS.git
cd PanteraS
```
