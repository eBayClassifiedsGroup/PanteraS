...
[![Current Release](http://img.shields.io/badge/release-0.3.0-blue.svg)](https://github.com/eBayClassifiedsGroup/PanteraS/releases/tag/v0.3.0)
...
Clone it
```
git clone -b 0.3.0 https://github.com/eBayClassifiedsGroup/PanteraS.git
cd PanteraS
```
